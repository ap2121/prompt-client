...
const ProfilePost = (props) => {
  return (
    ...
    <div style={{display: 'grid', justifyContent: 'center', alignItems: 'center', gridTemplateColumns: '400px', gap: '35px 35px'}}>
      <Card style={{width: '300px', height: '300px', marginBottom: '30px', boxShadow: 'rgba(0, 0, 0, 0.24) 0px 3px 8px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems:'center',  texAlign: 'center', gridTemplateColumns: '200px', background:  'rgba(9,9,118,1)', borderRadius: '15px'}}>
